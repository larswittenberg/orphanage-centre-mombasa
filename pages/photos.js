		...
		<div>
			<Navigation />
				<main className="">
					...
					<ul className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-2 max-w-screen-xl mx-auto mt-24 px-4">
						{photos.map((photo, i) => (
							<li key={i} className="block h-40 sm:h-48 md:h-56 lg:h-64">
