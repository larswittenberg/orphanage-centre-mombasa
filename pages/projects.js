	...
	return (
		<LayoutDefault>
			<div class="prose prose-sm sm:prose lg:prose-lg mx-auto">
				...
				<Polaroid alt="Rice and beans" filename="projects-rice-and-beans.jpg" extraClassName="polaroid-left" w="840" h="680" />
				...
				<Polaroid alt="Tution at home" filename="projects-tution-at-home.jpg" w="840" h="680" />
				...
				<Polaroid alt="Asante Sana" filename="asante-sana.jpg" extraClassName="polaroid-left"  w="1320" h="830" />
			</div>
		</LayoutDefault>
	)
}
